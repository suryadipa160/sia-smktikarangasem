            ...
            <form role="form" method="post" action="/alumni/{{ $alumni->id }}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group @error('tanggal_lahir') has-error @enderror">
                  ...
                  <input type="text" id="datepicker" name="tanggal_lahir" class="form-control" placeholder="Masukkan tanggal" value="{{ \Carbon\Carbon::parse($alumni->tanggal_lahir)->format('m/d/Y') }}">
